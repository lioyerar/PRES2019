...
def drawWithoutRender(arbre, name, noms): #prend en arguments un arbre, name : le nom que l'on veut donner à l'image une fois l'arbre tracé, noms : tableaux de correspondance entre id des utilisateurs et leur pseudos
    model = []
